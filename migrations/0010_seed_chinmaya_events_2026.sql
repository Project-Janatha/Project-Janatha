-- 0010_seed_chinmaya_events_2026.sql
...
-- 75th-anniversary tour). Source-of-truth inventory at
-- scripts/scraped-events/2026-04-30_chinmaya-events.json.
--
-- DEPENDENCIES (apply in order):
--   0008  - adds centers 098-101 (CMNY, CCMT, Sidhbari, Mangalam) — 15
--           events FK to those rows
--   0009  - adds events.end_date and events.is_recurring columns; this
--           migration populates end_date for multi-day events
--
-- CATEGORY MAPPING (constants.ts):
--   91 SATSANG   - devotional gatherings, bhajans, chanting
--   92 BHIKSHA   - food offerings (none in this batch)
--   93 YAJNA     - discourses, scriptural study, fire offerings, chanting comps
--   94 CAMP      - multi-day immersives, summer camps, retreats, residential
--   95 FESTIVAL  - public celebrations (Holi, Gurudev Jayanti, inauguration)
--   99 OTHER     - workshops, service trips, social, multi-faceted programs
--
-- AMRIT YATRA: per the "one anchor for tour-style events" decision, the
-- umbrella entry plus 7 city-stop sub-events all anchor to Central Chinmaya
-- Mission Trust (id …-099) and reuse the official Amrit Yatra banner image.
--
-- All events are is_recurring = 0 (this batch deliberately excludes weekly
-- recurring satsangs/balavihars).

INSERT INTO events (
  id, title, description, date, end_date, is_recurring,
...
(
  ...
  29.6659766, -95.615816, '10353 Synott Rd, Sugar Land, TX - 77498, US',
  'c0000001-0000-0000-0000-000000000009', 0, 0,
  'gcc@chinmayahouston.org', NULL, 93,
  datetime('now'), datetime('now')
),
(
...
(
  ...
  '2026-05-09T09:00:00', NULL, 0,
  32.9903214, -96.7942022, 'Online (Webex)',
  'c0000001-0000-0000-0000-000000000088', 0, 0,
  'Ramesh Hegde, (972) 250-2470', 'https://cmdfw.org/wp-content/uploads/2026/04/image-1.png', 93,
  datetime('now'), datetime('now')
),
(
...
(
  ...
  '2026-06-15T09:00:00', '2026-06-26T15:00:00', 0,
  28.6680904, -81.2926141, 'Casselberry, FL, US',
  'c0000001-0000-0000-0000-000000000016', 0, 0,
  NULL, 'https://res.cloudinary.com/chinmayaorlando/image/upload/q_auto/cmo/2026/summercamp.jpg', 94,
  datetime('now'), datetime('now')
),
...
(
  ...
  '2026-05-11T18:30:00', '2026-05-14T20:30:00', 0,
...
(
  ...
  '2026-07-13T09:00:00', '2026-07-19T13:00:00', 0,
  41.7143174, -87.9470168, '11S080 Kingery Hwy, Willowbrook, IL - 60527, US',
  'c0000001-0000-0000-0000-000000000015', 0, 0,
  'rashmiraghuvir@gmail.com; 630-654-3370', 'https://dp3wphqn1yqa5.cloudfront.net/chinmaya_website/2026/01/30155246/Summercamp2026_EB_Mar31-791x1024.jpg', 94,
  datetime('now'), datetime('now')
),
...
(
  ...
  '2026-05-10T09:20:00', '2026-05-10T13:30:00', 0,
  ...
  'contact@cmportland.org', NULL, 95,
  datetime('now'), datetime('now')
),
(
  ...
  45.5446737, -122.8807329, 'Chinmaya Haridwar, 3551 NW John Olsen Pl, Hillsboro, OR - 97124, US',
  'c0000001-0000-0000-0000-000000000047', 0, 0,
  'contact@cmportland.org', NULL, 93,
  datetime('now'), datetime('now')
),
(
  ...
  '2026-05-16T08:30:00', NULL, 0,
  45.5446737, -122.8807329, 'Chinmaya Haridwar, 3551 NW John Olsen Pl, Hillsboro, OR - 97124, US',
  'c0000001-0000-0000-0000-000000000047', 0, 0,
  'contact@cmportland.org', 'https://cmportland.org/images/HanumanChalisaHavan.jpg', 93,
  datetime('now'), datetime('now')
),
...
(
  ...
  '2026-05-17T15:00:00', '2026-05-17T17:00:00', 0,
...
(
  ...
  '2026-06-06T16:30:00', '2026-06-06T18:30:00', 0,
  38.903992, -77.478483, '4350 Blue Spring Dr, Chantilly, VA - 20151, US',
  'c0000001-0000-0000-0000-000000000057', 0, 0,
  NULL, NULL, 94,
  datetime('now'), datetime('now')
...
(
  ...
  '2026-06-25', '2026-06-28', 0,
  43.0986956, -79.0896157, 'Life Gurukula, Niagara region, ON, CA',
  'c0000001-0000-0000-0000-000000000067', 0, 0,
  'hello@chinmayaniagara.com', 'https://i0.wp.com/www.chinmayaniagara.com/wp-content/uploads/2026/03/WhatsApp-Image-2026-03-01-at-09.54.29.jpeg', 94,
  datetime('now'), datetime('now')
),
...
(
  ...
  '2026-06-01', '2026-07-31', 0,
  33.9004478, -84.1743202, '5511 Williams Rd, Norcross, GA - 30093, US',
  'c0000001-0000-0000-0000-000000000065', 0, 0,
  '(404) 781-9151; bvcoordinators@chinmaya-atlanta.com', 'https://chinmaya-atlanta.com/wp-content/uploads/2026/02/Summer-Camp-2026.jpeg', 94,
  datetime('now'), datetime('now')
),
...
(
  ...
  'info@chinmayanewyork.org', 'https://chinmayanewyork.org/wp-content/uploads/2026/02/HanmanChalisaHavan.webp', 93,
  datetime('now'), datetime('now')
),
(
  ...
  40.8203, -73.4684, '129 Woodbury Rd, Woodbury, NY - 11797, US',
  'c0000001-0000-0000-0000-000000000098', 0, 0,
  'info@chinmayanewyork.org', 'https://chinmayanewyork.org/wp-content/uploads/2026/04/Final-CMNY-Upavan-Hanuman-Havan.png', 95,
  datetime('now'), datetime('now')
),
...
(
  ...
  '2026-06-14', '2026-07-19', 0,
  31.9938, -96.6394, 'Chinmaya Mangalam, 10470 W FM 744, Barry, TX - 75102, US',
  'c0000001-0000-0000-0000-000000000101', 0, 0,
  'yepamerica7@gmail.com', 'https://chykwest.org/wp-content/uploads/2024/01/discourse.webp', 94,
  datetime('now'), datetime('now')
),
...
(
  ...
  'ccmt@chinmayamission.com, +91-22-2803-4900', 'https://images.chinmayamission.com/uploads/YATRA_BANNER_9320f94db2.jpeg', 99,
  datetime('now'), datetime('now')
),
(
  ...
  '2026-04-09', '2026-04-11', 0,
  19.1197, 72.9053, 'Chinmaya Vidyalaya, Thiruvananthapuram, Kerala, IN',
  'c0000001-0000-0000-0000-000000000099', 0, 0,
  'ccmt@chinmayamission.com', 'https://images.chinmayamission.com/uploads/amrit_yatra_691ed27a91.png', 93,
  datetime('now'), datetime('now')
),
(
...
(
  ...
  'c0000001-0000-0000-0000-000000000099', 0, 0,
  'chennaichinmaya@gmail.com, 044-28365046', 'https://images.chinmayamission.com/uploads/amrit_yatra_691ed27a91.png', 93,
  datetime('now'), datetime('now')
),
(
...
(
  ...
  'sidhbari@chinmayamission.com, +91-1892-236199', 'https://images.chinmayamission.com/uploads/631b3eac-7bdb-4d81-a0a3-474d5de9cd12.jpeg', 94,
  datetime('now'), datetime('now')
),
(
